...
2. Review every `create`, `skip`, and `conflict` result. Treat existing files as user-owned.
...
- Never overwrite or append to an existing file. Report a conflict with the expected content instead.
